...
include ('/etc/zpanel/panel/modules/apc_module/code/accode.php');
...
div.div1,div.div2 { margin-bottom:1em; width:30em; }
div.div3 { position:absolute; left:32em; top:1em; width:500px; }
...
<div class="head">
	<h1 class="apc">
		<div class="logo"><span class="logo"><a href="http://pecl.php.net/package/APC" target="_blank">APC</a></span></div>
...
EOB;
	...
	echo <<< EOB
		...
		<table cellspacing=0><tbody>
EOB;
	$size='width='.(GRAPH_SIZE+20).' height='.(GRAPH_SIZE+6);
	echo <<<EOB
		<tr>
...
EOB;
	...
	if (graphics_avail()) {
		$size='width='.(2*GRAPH_SIZE+70).' height='.(GRAPH_SIZE+10);
		echo <<<EOB
